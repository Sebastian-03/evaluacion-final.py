...
cursor_obj . ejecutar ( "BOTAR TABLA SI EXISTE TASA_DE_CAMBIOS" )
tabla  =  """ CREAR TABLA TASA_DE_CAMBIOS (
            ID ENTERO CLAVE PRIMARIA AUTOINCREMENTO,
            COMPRA VARCHAR(25) NO NULO,
            VENTA VARCHAR(25) NO NULO,
            MONEDA VARCHAR(25) NO NULO,
            FECHA_CAMBIO TIMESTAMP NO NULO
        ); """
